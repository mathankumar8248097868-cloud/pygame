"""
TAPLE TEENI – 2-Player Table Tennis
Pygame | Local Multiplayer | Clickable RESTART
"""
...
class Game:
    ...
    def reset(self):
        self.p1 = Paddle(100, config.P1_COLOR)
        self.p2 = Paddle(config.SCREEN_WIDTH - 100, config.P2_COLOR)
        self.ball = Ball()
        self.score_p1 = 0
        self.score_p2 = 0
        self.winner = None
    ...
    def update(self):
        ...
        self.p1.update(pygame.K_w, pygame.K_s)
        self.p2.update(pygame.K_UP, pygame.K_DOWN)
    ...
    def draw(self):
        ...
        # Player labels
        p1_label = self.font_small.render("P1", True, config.P1_COLOR)
